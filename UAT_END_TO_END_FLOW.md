# UAT End-to-End Flow Guide - DID Credential Manager
...
- Complete the setup steps in `UAT_SETUP.md`
...
You will see a comprehensive DMV application form. The form has default values pre-filled, but you can modify them:

**Personal Information:**
- **First Name:** Default "Alice" (you can change this)
- **Last Name:** Default "Wang" (you can change this)
- **Middle Name:** Optional
- **Date of Birth:** Default "1995-01-01" (format: YYYY-MM-DD)
- **Gender:** Default "F" (options: M/F/X)
- **Eye Color:** Default "Brown"
- **Height (cm):** Optional
- **Email:** Default "alice@example.com"

**Address Information:**
- **Street:** Default "123 Main St"
- **City:** Default "Seattle"
- **State:** Default "WA"
- **Postal Code:** Default "98101"
- **Country:** Default "US"

**Application Details:**
- **Application ID:** Auto-generated (e.g., "APP-2025-1234")
- **Phone:** Default "206-555-0101"
- **SSN Last 4:** Default "1234"
- **Organ Donor:** Checkbox
- **Residency Years:** Optional
- **Vision Test Completed:** Checkbox

Note: You can use the default values or modify them as needed for testing.
...
- The wallet has a modern dark-themed interface
- You will see navigation tabs at the bottom or sidebar:
  - **Credentials** (home view)
  - **Scan** (for QR codes and invitations)
  - **Present** (for creating presentations)
  - **Settings**
- The Holder's DID is displayed somewhere in the interface
- Example format: `did:peer:2.Ez6LS...`
